...
def generate_summary():
    ...
    with open(txt_filename, mode="w", encoding="utf-8") as file:  # 🔹 Se agrega encoding="utf-8"
        file.writelines([
    ...
    if detected_pupil is None:
        ...
        if eye_closed:
            ...
            if lost_pupil_frames <= max_lost_frames:
                ...
                # 🚀 🚀 🚀 **Nueva regla para microcortes: Confirmación extra**
...
def main():
    ...
    #Definimos la ROI x = 300, y = 200: esquina superior izquierda.
    #w = 150, h = 100: ancho y alto del rectángulo.

    roi_x, roi_y, roi_w, roi_h = 300, 200, 150, 100
    roi = (roi_x, roi_y, roi_w, roi_h)

    # Lanzamos hilo del gráfico

    try:
        Thread(target=plot_all_graphs, daemon=True).start()

    # Bucle principal de la captura
